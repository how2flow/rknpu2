...
#include <set>
#include <vector>
#define LABEL_NALE_TXT_PATH "./model/mask_labels_list.txt"
...
//  float  thres      = unsigmoid(threshold); // if model already contains "sigmoid" layers, delete this line. on the next line, change thres to threshold. and delete sigmoid operations all.
  int8_t thres_i8   = qnt_f32_to_affine(/* thres ,*/threshold, zp, scale);
  for (int a = 0; a < 3; a++) {
